...
<body>
    ...
    <table style="border: 2px solid black;width: 40%;"align = "center">
        ...
        <tr><td>ชื่อบัญชี</td><td><input type="text"name = "id" size="50"></td></tr>
        <tr><td>รหัสผ่าน</td><td><input type="text" name = "password" size="50"></td></tr>
        <tr><td>ชื่อ - นามสกุล</td><td><input type="text" name = "fullname" size="50"></td></tr>
        <tr>
            <td>
                เพศ:
            </td>
